...
var author$project$Main$Model = function (year) {
	return function (month) {
		return function (day) {
			return function (currentYear) {
				return function (currentMonth) {
					return function (currentDay) {
						return function (events) {
							return function (viewStatus) {
								return function (eventDay) {
...
var author$project$Main$dateToTuple = function (d) {
	return _Utils_Tuple3(
		isaacseymour$deprecated_time$Time$Date$year(d),
...
var author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			...
			default:
				var diff = msg.a;
				var current = A3(isaacseymour$deprecated_time$Time$Date$date, model.year, model.month, model.day);
				var moved = A2(isaacseymour$deprecated_time$Time$Date$addMonths, diff, current);
				var _n3 = author$project$Main$dateToTuple(moved);
				var y = _n3.a;
				var m = _n3.b;
				var d = _n3.c;
				return _Utils_Tuple2(
...
var author$project$Main$InputEvent = F2(
	function (a, b) {
...
var author$project$Main$lastDay = F2(
	function (y, m) {
		return A2(isaacseymour$deprecated_time$Time$Date$daysInMonth, y, m);
	});
var author$project$Main$toIntWeekday = function (d) {
	switch (d.$) {
		case 'Sun':
			return 0;
		case 'Mon':
...
var author$project$Main$leftDates = function (_n0) {
	var y = _n0.a;
	var m = _n0.b;
	var d = _n0.c;
	return A2(
		elm$core$List$map,
		function (diff) {
			return author$project$Main$dateToTuple(
				A2(
					isaacseymour$deprecated_time$Time$Date$addDays,
					diff,
					A3(isaacseymour$deprecated_time$Time$Date$date, y, m, d)));
		},
		A2(
			elm$core$List$range,
			-author$project$Main$toIntWeekday(
				isaacseymour$deprecated_time$Time$Date$weekday(
					A3(isaacseymour$deprecated_time$Time$Date$date, y, m, d))),
			-1));
};
var author$project$Main$rightDates = function (_n0) {
	var y = _n0.a;
	var m = _n0.b;
	var d = _n0.c;
	return A2(
		...
		A2(
			elm$core$List$range,
			1,
			6 - author$project$Main$toIntWeekday(
				isaacseymour$deprecated_time$Time$Date$weekday(
					A3(isaacseymour$deprecated_time$Time$Date$date, y, m, d)))));
};
var author$project$Main$createDates = F2(
	function (year, month) {
		var right = author$project$Main$rightDates(
			_Utils_Tuple3(
				year,
				month,
				A2(author$project$Main$lastDay, year, month)));
		var middle = A2(
			elm$core$List$map,
			function (d) {
				return _Utils_Tuple3(year, month, d);
			},
			A2(
				elm$core$List$range,
				1,
				A2(author$project$Main$lastDay, year, month)));
		var left = author$project$Main$leftDates(
			_Utils_Tuple3(year, month, 1));
		return _Utils_ap(
			left,
			_Utils_ap(middle, right));
	});
...
var author$project$Main$findEvents = F2(
	function (model, _n0) {
		...
		return A2(
			elm$core$List$filter,
			function (e) {
				return _Utils_eq(e.year, y) && (_Utils_eq(e.month, m) && _Utils_eq(e.day, d));
			},
			model.events);
	});
...
var author$project$Main$viewEventTag = function (e) {
	return A2(
		elm$html$Html$p,
		_List_fromArray(
			[
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					author$project$Main$ShowModel(d))
				]),
			_List_fromArray(
				[
					A2(
					...
					_List_fromArray(
						[
							elm$html$Html$text(
							author$project$Main$toStringDay(d))
						])),
					A2(
					elm$html$Html$div,
					_List_fromArray(
						[
							elm$html$Html$Attributes$class('day-events')
						]),
					A2(
						elm$core$List$map,
						function (e) {
							return author$project$Main$viewEventTag(e);
						},
						A2(author$project$Main$findEvents, model, d)))
				]));
	});
var author$project$Main$dayList = function (model) {
	return A2(
		elm$core$List$map,
		function (d) {
			return A2(author$project$Main$viewDay, model, d);
		},
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								elm$html$Html$Attributes$class('material-icons calender-icon')
							]),
						_List_fromArray(
							[
								elm$html$Html$text('event_note')
							])),
						A2(
						elm$html$Html$span,
						_List_Nil,
							...
							[
								...
								_List_fromArray(
									[
										elm$html$Html$Attributes$class('material-icons'),
										elm$html$Html$Events$onClick(
										author$project$Main$ChangeMonth(-1))
									]),
								_List_fromArray(
									[
										elm$html$Html$text('chevron_left')
									])),
								A2(
								elm$html$Html$i,
								_List_fromArray(
								...
								_List_fromArray(
									[
										elm$html$Html$text('chevron_right')
									]))
							])),
						A2(
						elm$html$Html$span,
						...
						_List_fromArray(
							[
								elm$html$Html$text(
								elm$core$String$fromInt(model.year) + ('年' + (elm$core$String$fromInt(model.month) + '月')))
							]))
					])),
				A2(
				elm$html$Html$div,
				_List_fromArray(
					[
						elm$html$Html$Attributes$class('calender-main')
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								elm$html$Html$Attributes$class('calender-days')
							]),
